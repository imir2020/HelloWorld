...
public class FindDuplicates {
    ...
    public static <T> List<List<T>> getEquals(List<List<T>> paths, Comparator<T> comparatorFunc) {
        ...
        for (List<T> pList : paths) {
            int[] foundIdx = new int[pList.size()]; // массив найденных, храним индекс в массиве результатов
    ...
    // в заданных списках T obj оставит только с одинаковым значением comparatorFunc
